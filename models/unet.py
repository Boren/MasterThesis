...
def unet(input_size: int, num_classes: int, channels: int = 3) ->\
    ...
    with keras_backend.name_scope('Decode_1'):
        ...
        upconv1 = Conv2D(256, (1, 1), activation='relu', padding='same')(up1)
    ...
    with keras_backend.name_scope('Decode_2'):
        ...
        upconv2 = Conv2D(256, (1, 1), activation='relu', padding='same')(up2)
    ...
    with keras_backend.name_scope('Decode_3'):
        ...
        upconv3 = Conv2D(256, (1, 1), activation='relu', padding='same')(up3)
    ...
    with keras_backend.name_scope('Decode_4'):
        ...
        upconv4 = Conv2D(256, (1, 1), activation='relu', padding='same')(up4)
